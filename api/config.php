...
<html>
  ...
  <body>
      <div class="body-container" style="background-color: #b2dfdb !important; font-family: Arial, sans-serif; padding: 40px !important;">
          <div class="logo-container" style="text-align: center;">
            <img src="https://www.tidolasab.com/static/media/logo_final.9655083de4a46582f8d2.png" alt="Logo" class="logo" style="margin: 20px auto;">
          </div>
          <div class="container" style="width: 80%; margin: 40px auto; background-color: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
              $message
          </div>
      </div>
  </body>
